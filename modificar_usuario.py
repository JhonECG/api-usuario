    ...
    try:
        ...
        if not updated_user:
            return {
                'statusCode': 404,
                'headers': {'Access-Control-Allow-Origin': '*'},
                'body': json.dumps({'message': 'No se encontró el usuario para modificar'})
            }
        ...
        return {
            'statusCode': 200,
            'headers': {'Access-Control-Allow-Origin': '*'},
            'body': json.dumps({'message': 'Usuario modificado exitosamente', 'user': updated_user})
        }
        ...
        return {
            'statusCode': 500,
            'headers': {'Access-Control-Allow-Origin': '*'},
            'body': json.dumps({'message': 'Error al modificar usuario', 'error': str(e)})
        }